                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                    <div class="service-one__item">
                        <div class="service-one__wrapper">
                            ...
                            <h3 class="service-one__title">
                                <a href="course.html">Fast delivery</a>
                            </h3><!-- /.service-title -->
                            <!-- <p class="service-one__text">Lorem ipsum dolor sit amet consectetur. Convallis ornare semper id hendrerit diam. Mauris cursus suscipit</p> -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                    <div class="fact-one__item text-center h-100">
                        <h3 class="fact-one__title">Hands-on Lab Exercises with Atlassian Jira Cloud</h3><!-- /.fact-one__title -->
                    </div><!-- /.fact-item -->
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                    <div class="fact-one__item text-center h-100">
                        <h3 class="fact-one__title">Hands-on Lab Exercises with Confluence Jira Cloud</h3><!-- /.fact-one__title -->
                    </div><!-- /.fact-item -->
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                    <div class="fact-one__item text-center h-100">
                        <h3 class="fact-one__title">Atlassian Jira Certification Guidance</h3><!-- /.fact-one__title -->
                    </div><!-- /.fact-item -->
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                    <div class="fact-one__item text-center h-100">
                        <h3 class="fact-one__title">Placement Guidance (Technical & HR Rounds)</h3><!-- /.fact-one__title -->
                    </div><!-- /.fact-item -->
                </div>
            </div>
        </div>
