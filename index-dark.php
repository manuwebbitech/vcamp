...
<body class="custom-cursor">
    ...
    <section class="fact-one" style="background-image: url(assets/images/shapes/fact-bg-1.png);">
        <div class="container">
            <h2 class="section-title__title text-dark text-center mb-5">Services</h2>
                        ...
                        <div class="blog-two__content">
                            ...
                            <div class="row">
                                <h3 class="blog-two__title col-10">
                                    <a href="#">The Complete Jira Workflow & Project Management Mastery Guide</a>
                                </h3><!-- /.blog-title -->
                                <a class="blog-two__rm col-2" href="#"><span class="icon-arrow"></span></a><!-- /.read-more-btn -->
                            </div>
                        </div><!-- /.blog-content -->
                    </div><!-- /.blog-card-one -->
                </div>
                ...
                <div class="col-xl-5 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                    <div class="blog-two__item">
                        ...
                        <div class="blog-two__content">
                            ...
                            <div class="row">
                                <h3 class="blog-two__title col-10">
                                    <a href="#">Confluence Mastery 2025: Collaboration, Workspaces & Documentation</a>
                                </h3><!-- /.blog-title -->
                                <a class="blog-two__rm col-2" href="#"><span class="icon-arrow"></span></a><!-- /.read-more-btn -->
                            </div>
                        </div><!-- /.blog-content -->
