...
<body class="custom-cursor">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="hero-banner__content">
                        ...
                        <h2 class="hero-banner__title wow fadeInUp" data-wow-delay="400ms"> VKAMP<br> Software Academy Conducts</h2>
                        <p class="hero-banner__text wow fadeInUp" data-wow-delay="500ms">
                            “Jira & Confluence Cloud Hands-on for IT Jobs”
                            <img src="assets/images/shapes/banner-1-shape-1.png" alt="eduact">
                        </p>
                        <div class="hero-banner__btn wow fadeInUp" data-wow-delay="600ms">
                            <a href="contact.php" class="eduact-btn eduact-btn-second"><span class="eduact-btn__curve"></span>Take Now<i class="icon-arrow"></i></a>
                        </div><!-- banner-btn -->
                    </div><!-- banner-content -->
                </div>
                <div class="col-lg-6">
    ...
    <div class="scroll-banner">
        <div class="scroll-track">
            ...
            <div class="scroll-group">
                <span class="scroll-text">IT Software Project Setup</span>
                <span class="scroll-star">✦</span>
                <span class="scroll-text">Software Project Administration & Support</span>
                <span class="scroll-star">✦</span>
                <span class="scroll-text">Technology Consulting</span>
                <span class="scroll-star">✦</span>
                <span class="scroll-text">Corporate Training - Software Tools</span>
                <span class="scroll-star">✦</span>
            </div>
    ...
    <!-- About Start -->
    <section class="about-one" id="about-sec">
        <div class="container">
            <div class="row">
                <div class="col-xl-6">
                ...
                <div class="col-xl-6 d-flex align-items-center">
                    <div class="about-one__content"><!-- about content start-->
                        <div class="section-title">
                            ...
                            <h2 class="section-title__title">Creating a Lifelong Learning Community</h2>
                        </div><!-- section-title -->
                        <p class="about-one__content__text">
                            VKAMP Tech Solutions provides affordable, reliable, and expert administration services for Atlassian tools like Jira and Confluence.
                            We help startups, small IT companies, and project teams streamline project management, documentation, and workflow automation with minimal cost.

                        </p>
                        <!-- <div class="about-one__box">
                            <div class="about-one__box__wrapper">
                                <div class="about-one__box__icon"><span class="icon-Presentation"></span></div>
                                <h4 class="about-one__box__title">Duration: 6 Weeks</h4>
                            </div>
                        </div> -->
    ...
    <section class="service-one">
        ...
        <div class="container">
            <!-- <h5 class="section-title__tagline text-center mb-3">
                Learn EXACTLY “What Companies Use”
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 133 13" fill="none">
                    <path d="M9.76794 0.395L0.391789 9.72833C-0.130596 10.2483 -0.130596 11.095 0.391789 11.615C0.914174 12.135 1.76472 12.135 2.28711 11.615L11.6633 2.28167C12.1856 1.76167 12.1856 0.915 11.6633 0.395C11.1342 -0.131667 10.2903 -0.131667 9.76794 0.395Z" fill="#F1F2FD" />
                    <path d="M23.1625 0.395L13.7863 9.72833C13.2639 10.2483 13.2639 11.095 13.7863 11.615C14.3087 12.135 15.1593 12.135 15.6816 11.615L25.0578 2.28167C25.5802 1.76167 25.5802 0.915 25.0578 0.395C24.5287 -0.131667 23.6849 -0.131667 23.1625 0.395Z" fill="#F1F2FD" />
                    <path d="M36.5569 0.395L27.1807 9.72833C26.6583 10.2483 26.6583 11.095 27.1807 11.615C27.7031 12.135 28.5537 12.135 29.076 11.615L38.4522 2.28167C38.9746 1.76167 38.9746 0.915 38.4522 0.395C37.9231 -0.131667 37.0793 -0.131667 36.5569 0.395Z" fill="#F1F2FD" />
            ...
            <h2 class="section-title__title text-center mb-4">Why Choose Us?</h2>
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                    <div class="service-one__item">
                        <div class="service-one__wrapper">
                            ...
                            <h3 class="service-one__title">
                                <a href="team-become.html">Trained & certified team</a>
                            </h3><!-- /.service-title -->
                            <!-- <p class="service-one__text">Lorem ipsum dolor sit amet consectetur. Convallis ornare semper id hendrerit diam. Mauris cursus suscipit</p> -->
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                    <div class="service-one__item">
                        <div class="service-one__wrapper">
                            ...
                            <h3 class="service-one__title">
                                <a href="about.html">100% remote support</a>
                            </h3><!-- /.service-title -->
                            <!-- <p class="service-one__text">Lorem ipsum dolor sit amet consectetur. Convallis ornare semper id hendrerit diam. Mauris cursus suscipit</p> -->
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                    <div class="service-one__item">
                        <div class="service-one__wrapper">
                            ...
                            <h3 class="service-one__title">
                                <a href="about.html">Custom solutions small companies for</a>
                            </h3><!-- /.service-title -->
                            <!-- <p class="service-one__text">Lorem ipsum dolor sit amet consectetur. Convallis ornare semper id hendrerit diam. Mauris cursus suscipit</p> -->
                            <!-- <a class="service-one__rm" href="about.html">Read More<span class="icon-caret-right"></span></a> -->
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 118 129" fill="none">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                    <div class="service-one__item">
                        <div class="service-one__wrapper">
                            ...
                            <h3 class="service-one__title">
                                <a href="about.html">Evening support available</a>
                            </h3><!-- /.service-title -->
                            <!-- <p class="service-one__text">Lorem ipsum dolor sit amet consectetur. Convallis ornare semper id hendrerit diam. Mauris cursus suscipit</p> -->
                            <!-- <a class="service-one__rm" href="about.html">Read More<span class="icon-caret-right"></span></a> -->
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 118 129" fill="none">
    ...
    <!-- Service End -->
    <section class="fact-one" id="services" style="background-image: url(assets/images/shapes/fact-bg-1.png);">
        <div class="container">
            <h2 class="section-title__title text-dark text-center mb-5">Our Courses</h2>

            <div class="row justify-content-center">
                <div class="col-xl-5 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                    <div class="blog-two__item">
                        <div class="blog-two__image">
                            <img src="assets/images/jira-logo.webp" alt="eduact">
                            <a href="jira.php"></a>
                        </div><!-- /.blog-image -->
                        <div class="blog-two__content">
                            <div class="blog-two__top-meta">
                                <div class="blog-two__cats"><a href="jira.php">Jira</a></div><!-- /.blog-cats -->
                            </div>
                            <div class="row">
                                <h3 class="blog-two__title col-10">
                                    <a href="jira.php">Jira Workflow & Project Management Mastery</a>
                                </h3><!-- /.blog-title -->
                                <a class="blog-two__rm col-2" href="jira.php"><span class="icon-arrow"></span></a><!-- /.read-more-btn -->
                            </div>
                        </div><!-- /.blog-content -->
                    </div><!-- /.blog-card-one -->
                </div>
                ...
                <div class="col-xl-5 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                    <div class="blog-two__item">
                        <div class="blog-two__image">
                            <img src="assets/images/confluence.webp" alt="eduact">
                            <a href="confluence.php"></a>
                        </div><!-- /.blog-image -->
                        <div class="blog-two__content">
                            <div class="blog-two__top-meta">
                                <div class="blog-two__cats"><a href="confluence.php">Confluence</a></div><!-- /.blog-cats -->
                            </div>
                            <div class="row">
                                <h3 class="blog-two__title col-10">
                                    <a href="confluence.php">Confluence Workspace & Documentation Mastery</a>
                                </h3><!-- /.blog-title -->
                                <a class="blog-two__rm col-2" href="confluence.php"><span class="icon-arrow"></span></a><!-- /.read-more-btn -->
                            </div>
                        </div><!-- /.blog-content -->
                    </div><!-- /.blog-card-one -->
                </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-7 wow fadeInLeft" data-wow-delay="200ms">
                    <div class="cta-one__left">
                        ...
                        <h3 class="cta-one__left__title">Skills Certificate From VKAMP</h3>
                        <a href="contact.php" class="eduact-btn eduact-btn-second"><span class="eduact-btn__curve"></span>Get Start Now<i class="icon-arrow"></i></a>
                    </div>
                </div>
