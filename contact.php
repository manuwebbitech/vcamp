...
<!-- Mirrored from bracketweb.com/eduact-html/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Dec 2025 05:07:18 GMT -->
<head>
            ...
            <div class="container">
                <ul class="contact-info__wrapper">
                    <li>
                        ...
                        <h4 class="contact-info__text">Free <a href="tel:+91 9940841991">+91 9940841991</a></h4>
                    </li>
                    <li class="active">
                        <div class="contact-info__icon"><span class="icon-Email"></span></div>
                        <p class="contact-info__title">Send Email</p>
                        <h4 class="contact-info__text"><a href="mailto:info@vkamptechsolutions.com">info@vkamptechsolutions.com</a></h4>
                    </li>
                    <li>
                        <div class="contact-info__icon"><span class="icon-Location"></span></div>
                        <p class="contact-info__title">Visit Anytime</p>
                        <h4 class="contact-info__text"> Coimbatore, Tamil Nadu</h4>
                    </li>
                </ul>
            </div>
        </section>
